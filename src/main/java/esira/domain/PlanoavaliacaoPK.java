...
public class PlanoavaliacaoPK implements Serializable {
    ...
    public PlanoavaliacaoPK(long iddisc, int turno, int turma, int idtipoavaliacao, int ano) {
        this.iddisc = iddisc;
        this.turno = turno;
        this.turma = turma;
    ...
    public String toString() {
        return "esira.domain.PlanoavaliacaoPK[ iddisc=" + iddisc + ", turno=" + turno + ", turma=" + turma + ", idtipoavaliacao=" + idtipoavaliacao + ", ano=" + ano + " ]";
    }
